...
class Bayesian_optimization:
    ...
    def __init__(self, data_path, test_path, task=Model, algorithm=rfcAlgo, mode='random', metrics = ['auc','f1','pre'], default_params=False, cont_book={}, disc_book={}, enum_book={}, stat_book={}, cons_value=10.0, rbf_value=10.0, acq_num=DEFAULT_ACQ_NUM, worker=DEFAULT_WORKER, fidelity=3, modify=False, calculate_feature_importance=True):
        ...
        self.task = task(data_path=data_path, algorithm=algorithm,  mode=mode,  modify=True, test_clusters=4, calculate_feature_importance=True)
...
if __name__ == '__main__':
    ...
    bo = Bayesian_optimization(
        ...
        test_path='G:/A PYTHON NOTEBOOK/Bayesian_main/ooddata/washington_ood_mask.npy',
        algorithm=algo, 
        mode='OOD',
        default_params= True,
    ...
    x_best, X, y = bo.optimize(steps=10, return_trace=True)
    
    print(x_best)

    # print(f'{algo.__name__}: {y}',  x_best, X, y)